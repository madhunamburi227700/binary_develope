...
DROP TABLE IF EXISTS remediation_feedback CASCADE;
DROP TABLE IF EXISTS remediation_verification CASCADE;
DROP TABLE IF EXISTS remediations CASCADE;
DROP TABLE IF EXISTS vulnerabilities CASCADE;
DROP TABLE IF EXISTS scan_type CASCADE;
DROP TABLE IF EXISTS scans CASCADE;
DROP TABLE IF EXISTS settings CASCADE;
DROP TABLE IF EXISTS hubs CASCADE;

DROP TYPE IF EXISTS remediation_status_t;
DROP TYPE IF EXISTS verification_status_t;
DROP TYPE IF EXISTS scan_status_t;
